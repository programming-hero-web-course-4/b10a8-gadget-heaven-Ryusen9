...
const Menu = ({menu}) => {
  ...
  return (
    <div className={`border-2 md:border-0 ${menu === true ? '-translate-y-[500%]' : 'translate-y-[0%]'} absolute top-16 right-7 h-56 w-56 rounded-lg z-20 md:top-0 md:right-0 py-5 md:py-0 md:gap-0 duration-200 ease-in md:relative md:translate-y-0 md:flex md:h-7 md:w-[100%] px-3`}>
